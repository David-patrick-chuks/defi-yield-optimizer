...
const Index = () => {
  ...
  return (
    <MainLayout>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-50 via-slate-50 to-blue-50 border-b">
                  ...
                  <div className="space-y-4">
                    <div className="bg-slate-50 rounded-lg p-4">
                      ...
                      <div className="h-1 bg-slate-200 rounded-full mb-2">
                        <div className="h-1 bg-blue-500 rounded-full" style={{ width: '42%' }}></div>
                      </div>
                    </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-3xl overflow-hidden shadow-xl">
